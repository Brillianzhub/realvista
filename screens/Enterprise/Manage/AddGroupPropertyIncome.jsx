...
import PropertyIncomeForm from '../Manage/AddIncomeForm';
...
const AddPropertyIncome = ({ route, navigation }) => {
    ...
    const handleFormSubmit = async (values) => {
        ...
        try {
            const response = await axios.post(
                `https://www.realvistamanagement.com/enterprise/property/add-income/`,
                values,
                {
                    headers: {
