...
import { Modal, View, Text, TextInput, TouchableOpacity, ActivityIndicator, Alert, TouchableWithoutFeedback } from 'react-native';
import AsyncStorage from '@react-native-async-storage/async-storage';
import { useGlobalContext } from "@/context/GlobalProvider";


const SubmitReferralModal = ({ visible, onClose }) => {
                ...
                <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', backgroundColor: 'rgba(0,0,0,0.5)' }}>
                    <TouchableWithoutFeedback>
                        <View style={{ width: 300, padding: 20, backgroundColor: 'white', borderRadius: 10 }}>
                            <Text style={{ fontSize: 18, fontWeight: 'bold', marginBottom: 10 }}>Enter Referrer Code</Text>
                            <TextInput
                            ...
                            {loading ? (
                                ...
                                <TouchableOpacity onPress={handleSubmit} style={{ backgroundColor: '#FB902E', padding: 10, borderRadius: 5, alignItems: 'center' }}>
